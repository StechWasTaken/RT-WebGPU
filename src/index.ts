...
if (
    adapter.limits &&
    (adapter.limits as any).maxBufferSize &&
    (adapter.limits as any).maxBufferSize > DEFAULT_MAX_BUFFER_LIMIT
) {
    requestedLimits["maxBufferSize"] = (adapter.limits as any).maxBufferSize;
}
...
const params = new ShaderConfig(10, 0);
